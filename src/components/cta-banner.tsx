...
export function CtaBanner({ title, text }: CtaBannerProps) {
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="surface-panel overflow-hidden rounded-[36px] px-6 py-10 sm:px-10 sm:py-12">
        <div className="absolute inset-y-0 right-0 hidden w-1/2 bg-[radial-gradient(circle_at_left,_rgba(255,231,185,0.18),_transparent_58%)] lg:block" />
        <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.35em] text-[var(--color-gold)]">
              Booking CTA
            </p>
            <h2 className="mt-4 font-serif-display text-4xl leading-tight text-[var(--color-cream)] sm:text-5xl">
              {title}
            </h2>
